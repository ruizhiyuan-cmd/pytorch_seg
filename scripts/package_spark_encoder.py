...
``restore_seg_encoder`` expects (mirrors cache/fcmae_5stage_atto_seg_encoder.pth).
    ...
    python scripts/package_spark_encoder.py \
        ...
        --out /mnt/home/ruizhi.yuan/pytorch_seg/cache/tenxnet_recipe_spark_seg_encoder.pth --epoch 100
"""
import argparse
import os
import sys
...
sys.path.insert(0, os.path.dirname(os.path.dirname(os.path.abspath(__file__))))  # pytorch_seg root
