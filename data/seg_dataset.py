...
The online target-gen reuses the validated standalone Cython via the parity glue
...
# reuse the validated parity glue (verbatim tenxnet wrappers + standalone .so loader)
_PARITY = "/mnt/home/ruizhi.yuan/pytorch_seg/parity"
if _PARITY not in sys.path:
    sys.path.insert(0, _PARITY)
from ridgepath_glue import inst_ridge_to_ridgepath, load_ops  # noqa: E402
