"""Ridgepath segmentation training / eval scaffolding (PyTorch, torch_ssl).
...
Examples (see configs/*.yaml):
  # smoke (few iters, CPU or 1 GPU) -- sanity only
  python train_seg.py --config configs/r18_scratch.yaml --smoke
  # single GPU
  python train_seg.py --config configs/r18_dino.yaml
  # optional DDP (4 GPUs)
