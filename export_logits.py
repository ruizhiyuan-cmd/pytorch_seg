...
Usage:
  python export_logits.py --config configs/tenxnet_small_dino_boundary2ch.yaml          # best.pth + cfg val
  python export_logits.py --config <cfg> --checkpoint runs/<run>/best.pth --out <dir> --n 5 --device cpu
"""
import argparse
import csv
import os
